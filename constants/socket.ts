...
export const SOCKET_MESSAGES = {
  ...
  WEBRTC_OFFER_ICE: 'WebrtcOfferIce',
  WEBRTC_ANSWER_ICE: 'WebrtcAnswerIce',
  WEBRTC_ANSWER_REJECT: 'WebrtcAnswerReject',
  WEBRTC_HANGUP: 'WebrtcHangup',
};
...
export const SOCKET_WEBRTC_OFFER = SOCKET_MESSAGES.WEBRTC_OFFER;
export const SOCKET_WEBRTC_ANSWER = SOCKET_MESSAGES.WEBRTC_ANSWER;
export const SOCKET_WEBRTC_OFFER_ICE = SOCKET_MESSAGES.WEBRTC_OFFER_ICE;
export const SOCKET_WEBRTC_ANSWER_ICE = SOCKET_MESSAGES.WEBRTC_ANSWER_ICE;
export const SOCKET_WEBRTC_ANSWER_REJECT = SOCKET_MESSAGES.WEBRTC_ANSWER_REJECT;
...
export const SOCKET_HANGUP = SOCKET_MESSAGES.WEBRTC_HANGUP;
/**
