...
const AlertDialogGroup = (props: IProps) => {
  const { visible, onClose, onConfirm, content } = props;

  return (
    <AlertDialog isOpen={visible} size='md'>
      <AlertDialogBackdrop />
      <AlertDialogContent>
        <AlertDialogHeader>
          <Text className='font-bold text-lg'>温馨提示</Text>
        </AlertDialogHeader>
        <AlertDialogBody className='mt-3 mb-8'>
          <Text>{content}</Text>
        </AlertDialogBody>
        <AlertDialogFooter>
...
AlertDialogGroup.displayName = 'AlertDialogGroup';
